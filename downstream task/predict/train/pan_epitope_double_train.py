...
sys.path.insert(0, b_directory)
from pan_epitope_double_train_util import *
...
def main():
    ...
    cal_(args.beta_train_emb_path,args.alpha_train_emb_path,args.ep_train_emb_path,args.train_labels_path,args.seed,
